					...
					<div class="loginbox" id="loginbox">
						<div class="loginbox2">
							<div class="loginbox-title">
								...
								<div class="loginbox-title2">
									<h5>로그인 정보를 입력해주세요.</h5>
								</div>
								<div class="loginbox-xbox">X</div>
							</div>
					...
					<form action="<%=request.getContextPath()%>/signup" method="post">
						<div class="signupbox" id="signupbox">
							<div class="signupbox-title">
								...
								<div class="signupbox-title2">
									<h5>회원 정보를 입력해주세요.</h5>
								</div>
								<div class="signupbox-xbox">X</div>
							</div>
